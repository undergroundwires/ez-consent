...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/ez-consent@1.2.0/dist/ez-consent.min.js"></script>
```
...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/ez-consent@1.2.0/dist/themes/box-bottom-left.min.css">
```
...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/ez-consent@1.2.0/dist/themes/subtle-bottom-right.min.css">
```
